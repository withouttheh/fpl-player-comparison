...
with col1:
    selected_player1 = st.selectbox("Type player name...", options=player_controller.model.elements_data['full_name'].sort_values(), key="Player 1")
    player_controller.display_player_info(selected_player1)

with col2:
    selected_player2 = st.selectbox("Type player name...", options=player_controller.model.elements_data['full_name'].sort_values(), key="Player 2")
